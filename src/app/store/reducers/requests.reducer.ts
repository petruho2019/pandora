...
export const INITIAL_REQUESTS_STATE: RequestState = {
  ...
  entities: {
    '10000000-0000-4000-8000-000000000001': {
      ...
      collectionId: 'dc378aa8-b42e-468a-bb5d-5dad6e0f9b7b',
      fileName: 'get-users',
    },
    '10000000-0000-4000-8000-000000000002': {
    ...
    '20000000-0000-4000-8000-000000000021': {
      ...
      auth: buildDefaultAuth(),
      body: buildDefaultBody(),
      collectionId: '33abfac2-d678-481c-aa9a-39ac8361bd3e',
      fileName: 'get-products',
    },
    '20000000-0000-4000-8000-000000000022': {
...
export const requestsReducer = createReducer(
  ...
  on(deleteRequestSuccess, (state, { newRequests }) => requestAdapter.setAll(newRequests, state)),
