...
export const loadRequests = createAction(
  '[Request] Load',
  props<{ collectionInfo: LoadRequestDto }>(),
);
export const loadRequestsSuccess = createAction(
  '[Request] Load Success',
  props<{ loadedRequests: RequestModel[]; collectionId: string }>(),
);
...
export const openRequestInFS = createAction(
  '[Request] Open in FS',
  props<{ requestInfo: OpenRequestInFSDto }>(),
);
export const openRequestInFSSuccess = createAction('[Request] Open Success in FS');
export const openRequestInFSFailure = createAction(
  '[Request] Open Failure in FS',
  props<{ errorMessage: string }>(),
);
